...
class AddActivityW : AppCompatActivity() {
    ...
    private val historyDao = MainApplication.databaseW.getHistoryDao()
    private val dashboardDao = MainApplication.databaseW.getDashboardDao()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_add_l)

        val productDao = MainApplication.databaseW.getProductDao()
