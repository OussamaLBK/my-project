...
class AddActivityP : AppCompatActivity() {
    ...
    private val historyDao = MainApplication.databaseP.getHistoryDao()
    private val dashboardDao = MainApplication.databaseP.getDashboardDao()
