...
class AddActivityWp : AppCompatActivity() {
    ...
    private val historyDao = MainApplication.databaseWp.getHistoryDao()
    private val dashboardDao = MainApplication.databaseWp.getDashboardDao()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_add_l)

        val productDao = MainApplication.databaseWp.getProductDao()
