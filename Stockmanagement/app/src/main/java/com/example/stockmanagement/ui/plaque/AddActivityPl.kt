...
class AddActivityPl : AppCompatActivity() {
    ...
    private val dashboardDao = MainApplication.databasePl.getDashboardDao()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_add_l)

        val productDao = MainApplication.databasePl.getProductDao()
